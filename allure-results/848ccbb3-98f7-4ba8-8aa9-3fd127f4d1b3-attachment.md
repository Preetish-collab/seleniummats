...
- Name: SingleDimensionalArray.spec.js >> search testlogin test mobiles
...
Call log:
  ...
  - waiting for locator('h2 a').first()
    14 × locator resolved to <a href="/25-virtual-gift-card">$25 Virtual Gift Card</a>
...
```ts
  ...
  3  | //testdata
  4  | const searchItems = ['laptop','mobiles','dress'];
