...
```ts
  ...
  10 |     };
> 11 |     const response=await request.post("https://restful-booker.herokuapp.com",{headers:{"Content-Type":"application/json","Authorization":`Basic  ${auth}`},data:{ authdata}});
     |                                                                                                                                                    ^ ReferenceError: auth is not defined
  ...
  47 | });
  48 | /*
  49 | npx playwright test tests/PutCall.spec.js 
  50 | */
  51 | 
  52 | 
```